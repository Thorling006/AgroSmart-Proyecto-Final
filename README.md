...
- ✅ **Sistema de Chat/Mensajería tipo Messenger**
  - 💬 Chat privado entre usuarios y administrador
  - 🔔 Notificaciones en tiempo real con burbuja de conteo
  - 📱 Interfaz moderna con colores turquesa y gris
  - 👥 Admin ve lista de todos los usuarios registrados
  - ✉️ Polling cada 2 segundos para sincronización
  - ✓✓ Indicador de mensajes leídos
  - 🔍 Buscador para encontrar usuarios (solo admin)
...
1. Haz clic en el botón "💬 Chat" en la barra de navegación (rojo con notificación)
2. Verás la conversación con el administrador (root)
3. Escribe tu mensaje en el campo inferior y presiona el botón de envío (📤)
4. Recibirás notificaciones automáticas cuando el admin responda
5. La burbuja de notificación mostrará el total de mensajes no leídos
6. Los mensajes enviados aparecen a la derecha en color turquesa
7. Los mensajes recibidos aparecen a la izquierda en color gris

#### Para Administrador (Root):
1. Haz clic en el botón "💬 Chat" en la barra de navegación
2. Verás una lista de todos los usuarios registrados en el sistema
3. Puedes usar el buscador (🔍) para encontrar usuarios por email
4. Haz clic en un usuario para iniciar o continuar la conversación
5. Los mensajes no leídos aparecen resaltados en color azul claro
6. La burbuja de notificación muestra el total de mensajes sin leer
7. Interfaz similar a Messenger con avatares y timestamps

#### Características del Chat:
- ✅ Mensajes en tiempo real (polling cada 2 segundos)
- ✅ Avatares con iniciales si no hay foto de perfil
- ✅ Contador de mensajes no leídos por usuario
- ✅ Timestamps precisos (dd/mm HH:mm)
- ✅ Indicador de lectura (✓✓) en mensajes recibidos
- ✅ Interfaz completamente responsiva
- ✅ Límite de 5000 caracteres por mensaje
- ✅ Auto-redimensionamiento del área de texto
- ✅ Colores optimizados: Turquesa (#4ecdc4) para enviados, Gris (#e8e8e8) para recibidos
...
├── monitor/
│   ├── models.py               # CustomUser, Crop, ChatMessage, etc.
│   ├── views.py                # Vistas de cultivos
│   ├── views_auth.py           # Vistas de autenticación
│   ├── views_admin.py          # Vistas administrativas
│   ├── views_chat.py           # Vistas de Chat/Mensajería (NUEVO)
│   ├── forms.py                # Formularios
│   ├── urls.py                 # Rutas del proyecto
│   └── migrations/
│       ├── 0010_chatmessage.py # Migración para ChatMessage
│       └── ...
├── templates/
│   ├── base.html               # Template base con navbar
│   ├── chat/                   # Templates de Chat (NUEVO)
│   │   ├── user_chat_list.html     # Lista de chat para usuarios
│   │   ├── admin_chat_list.html    # Lista de chat para admin
│   │   └── chat_detail.html        # Detalle de conversación
│   └── ...
├── static/
│   ├── css/                    # Estilos CSS
│   └── js/                     # JavaScript
...
OPENAI_API_KEY=***REMOVED***proj-lk_qehZlHkkmeWK1P3Wy0-hOizjjmDNGZ7_SpO0_X5kO995hb9eC7ejX3E712ADDSJKYCFtKJLT3BlbkFJFeiUopD8IArgo2DMbyCnAc_snuNRUn1cPQ1j3rdf3lqpUKybdDoNUxCSaarQnwbaU7f00ID1cA
