...
from .views_ia import ia_chat_screen
...
urlpatterns = [
    ...
    path("chat/<int:user_id>/", views_chat.chat_detail, name="chat_detail"),
    path("api/chat/<int:user_id>/enviar/", views_chat.send_message, name="send_message"),
    path("api/chat/no-leidos/", views_chat.get_unread_count, name="get_unread_count"),
    path("api/chat/<int:user_id>/nuevos/", views_chat.get_new_messages, name="get_new_messages"),
]
